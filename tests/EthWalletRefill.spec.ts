...
describe("ETH Wallet Refill", () => {
  ...
  it("Refill wallet when running out of funds", async () => {
    ...
    fakeProvider.injectResponse(
      "eth_getBalance",
      (payload) => balances[payload.params[0].toLowerCase()]
    ); // 900 ETH
    ...
    expect(rawTxReq.length).to.equal(
      1,
      "unexpected number of refill transactions"
    );
    expect(rawTxReq[0].params[0]).to.equal(
      "",
  ...
  it("Forward funds when exceeding overflow balance", async () => {
    ...
    expect(rawTxReq[0].params[0]).to.equal(
      "0x02f8778205392a847735940085174876e800830493e094a5058fbcd09425e922e3e9e78d569ab84edb88eb893635c9adc5dea0000080c080a0f6479155811e8cb2c8a47637d4ac8319b4368219d3e5fbabc67beed4329d4863a07272d4304be538f692670486fe0e3df02a2bd00163c7567a4b67f1a10ead8ea4",
      "unexpected refill transaction hex"
    );
  });
});
