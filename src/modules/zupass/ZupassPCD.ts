...
import { ZupassModule } from "./ZupassModule";
...
export class ZupassPCD {
  ...
  public constructor(module: ZupassModule) {
    this.module = module;
  }
  ...
  public async verifyTicket(pcd: ZKEdDSAEventTicketPCD): Promise<boolean> {
    ...
    const publicSignals = this.publicSignalsFromClaim(pcd.claim);
  ...
  public parseFaucetToken(faucetToken: string): IZupassPDCData {
