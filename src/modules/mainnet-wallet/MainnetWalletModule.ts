  ...
  private async processSessionStart(
    ...
    if (this.moduleConfig.minBalance > 0) {
      ...
      try {
        ...
        throw new FaucetError(
          "MAINNET_BALANCE_CHECK",
          "Could not get balance of mainnet wallet " +
            targetAddr +
            ": " +
            ex.toString()
        );
      ...
      if (walletBalance < minBalance)
        throw new FaucetError(
          ...
          "You need to hold at least " +
            ...
            " in your wallet on mainnet to use this faucet."
        );
    }
    ...
    if (this.moduleConfig.minTxCount > 0) {
      ...
      try {
        ...
        throw new FaucetError(
          "MAINNET_TXCOUNT_CHECK",
          "Could not get tx-count of mainnet wallet " +
            targetAddr +
            ": " +
            ex.toString()
        );
      ...
      if (walletTxCount < this.moduleConfig.minTxCount)
        throw new FaucetError(
          ...
          "You need to submit at least " +
            this.moduleConfig.minTxCount +
            " transactions from your wallet on mainnet to use this faucet."
        );
    }
  }
}
