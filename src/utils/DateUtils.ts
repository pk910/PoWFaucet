...
export const renderDate = (
  ...
  return (
    date.getFullYear() +
    "-" +
    strPadLeft(date.getMonth() + 1, 2, "0") +
    "-" +
    strPadLeft(date.getDate(), 2, "0") +
    (withTime
      ? " " +
        strPadLeft(date.getHours(), 2, "0") +
        ":" +
        strPadLeft(date.getMinutes(), 2, "0") +
        (withSec ? ":" + strPadLeft(date.getSeconds(), 2, "0") : "")
      : "")
  );
};
