 ...
 * @returns {Promise<any>}
 */
export function keyToVerificationMethod(
 ...
 * @returns {Promise<any>}
 */
export function completeIssueCredential(
  credential: string,
  preparation: string,
  signature: string
): Promise<any>;
 ...
 * @returns {Promise<any>}
 */
export function completeIssuePresentation(
  presentation: string,
  preparation: string,
  signature: string
): Promise<any>;
 ...
 * @returns {Promise<any>}
 */
export function completeDelegateCapability(
  capability: string,
  preparation: string,
  signature: string
): Promise<any>;
 ...
 * @returns {Promise<any>}
 */
export function completeInvokeCapability(
  invocation: string,
  preparation: string,
  signature: string
): Promise<any>;
